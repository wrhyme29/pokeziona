...
static void ClearMoveSelectionDisplayMoveDescriptionSplitIcon(void);
...
static void MoveSelectionDisplayMoveDescriptionSplitIcon(u8);
...
static void HandleInputChooseMove(void)
{
    ...
    if (sDescriptionSubmenu)
    {
        if (JOY_NEW(L_BUTTON) || JOY_NEW(A_BUTTON) || JOY_NEW(B_BUTTON))
        {
            ...
            ClearMoveSelectionDisplayMoveDescriptionSplitIcon();
            PlaySE(SE_SELECT);
            MoveSelectionDisplayPpNumber();
            MoveSelectionDisplayMoveType();
        }
...
static void ClearMoveSelectionDisplayMoveDescriptionSplitIcon(void)
{
    FillWindowPixelBuffer(B_WIN_MOVE_DESCR_PSS_ICON, PIXEL_FILL(0));
    ClearStdWindowAndFrame(B_WIN_MOVE_DESCR_PSS_ICON, FALSE);
    CopyWindowToVram(B_WIN_MOVE_DESCR_PSS_ICON, COPYWIN_GFX);
}

static void MoveSelectionDisplayMoveDescriptionSplitIcon(u8 moveCategory)
{
    LoadPalette(sSplitIcons_Pal, 10 * 0x10, 0x20);
    BlitBitmapToWindow(B_WIN_MOVE_DESCR_PSS_ICON, sSplitIcons_Gfx + 0x80 * moveCategory, 0, 0, 16, 16);
	PutWindowTilemap(B_WIN_MOVE_DESCR_PSS_ICON);
	CopyWindowToVram(B_WIN_MOVE_DESCR_PSS_ICON, COPYWIN_GFX);
}
...
static void MoveSelectionDisplayMoveDescription(void)
{
    ...
    u8 cat = gBattleMoves[move].category;
    ...
    MoveSelectionDisplayMoveDescriptionSplitIcon(cat);
}
