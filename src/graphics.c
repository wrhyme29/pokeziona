...
const u16 gTitleScreenZionaVersionPal[]    = INCGFX_U16("graphics/title_screen/ziona_version.png", ".gbapal");
...
const u32 gTitleScreenZionaVersionGfx[]    = INCGFX_U32("graphics/title_screen/ziona_version.png", ".8bpp.lz", "-mwidth 8 -mheight 4");
