...
const u8 gText_BirchNonbinary[] = _("NONBINARY");
const u8 gText_BirchMalePresenting[] = _("MALE PRESENTING");
const u8 gText_BirchFemalePresenting[] = _("FEMALE PRESENTING");
...
const u8 gText_BigPerson[] = _("Big person");
